...
Boardgame.create(title: "Brass: Birmingham", description: "Build networks, grow industries, and navigate the world of the Industrial Revolution.", price_per_day: 10, cover_url: "https://cf.geekdo-images.com/x3zxjr-Vw5iU4yDPg70Jgw__original/img/FpyxH41Y6_ROoePAilPNEhXnzO8=/0x0/filters:format(jpeg)/pic3490053.jpg", user_id: 1)
Boardgame.create(title: "Terraforming Mars", description: "Compete with rival CEOs to make Mars habitable and build your corporate empire.", price_per_day: 10, cover_url: "https://cf.geekdo-images.com/wg9oOLcsKvDesSUdZQ4rxw__original/img/thIqWDnH9utKuoKVEUqveDixprI=/0x0/filters:format(jpeg)/pic3536616.jpg", user_id: 1)
Boardgame.create(title: "Gloomhaven: Jaws of the Lion", description: "Vanquish monsters with strategic cardplay in a 25-scenario Gloomhaven campaign.", price_per_day: 10, cover_url: "https://cf.geekdo-images.com/_HhIdavYW-hid20Iq3hhmg__original/img/PBzsLRqNKQKJxGnzpb7o3qLWPQM=/0x0/filters:format(jpeg)/pic5055631.jpg", user_id: 1)
